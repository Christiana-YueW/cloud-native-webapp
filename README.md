...
Build Instructions
1. Clone Repository
bashgit clone git@github.com:YOUR_USERNAME/webapp.git
cd webapp
...
bash# Terminal 1: Start application
source venv/bin/activate
uvicorn app.main:app --host 127.0.0.1 --port 8000
Run tests with Newman:
bash# Terminal 2: Clean database and run tests
...
envDATABASE_URL=postgresql://username@localhost:5432/webapp_db
